...
= 8.5.1 [8th October 2025] =

= Added =

* Template Library preview fallback added

= 8.5.0 [25th September 2025] =

= Added =

* Theme Builder - Custom post type, woocommerce single product, product archive support added
* Time Controller added in events calendar carousel widget
* Added alignment control for the title in the Give Login widget
* Added hamburger dropdown height control in the mega menu widget
* Contact Form 7 Submit button Alignment Added ( Thanks to Emrah yavsan)
* Icon style controls added in tabs widget
* New widgets & extensions tutorial video added in - [Dynamic Grid](https://youtu.be/-BdpQ2lttSo?si=vpEHqHl_pTzQxhyY), [Dynamic Carousel](https://youtu.be/uc08OzVbq_g?si=3vCt8T4zeFSw4oiU), [SVG Maps](https://youtu.be/LZMtIMqBTZY?si=JvfHuTJWFWPXE5mc), [Text Gradient Background](https://youtu.be/J1DNE_Jx4Rs?si=l8Q5Y0ddMl9YzqEh), [Shape Divider](https://youtu.be/Onlgq2ND5EM?si=AceE8KxbPD46vlbS), [White Label](https://youtu.be/sXEgAgAKNDc?si=Rsw0nxFYylNhWuaQ), [Custom CSS & Js](https://youtu.be/2kWiUA_TcRY?si=6l0q7byh8-kT_zU4)

= Fixed =

* Backdrop filter container inner widget issue fixed
* Empty DOM loading issues fixed Fancy List Widget
* Inline class undefined issue fixed in webhook form widget
* Multi data formatting fixed in Webhook Form widget
* Add conditional rendering for address section in Events Calendar Carousel widget
* Nav spacing row gap issue fixed in tabs widget
* Liquid glass effect overflow issue fixed in backdrop filter extension
* Google reviews arrows space between issue fixed
* Ninja forms submit button style & fullwidth controls issue fixed
* Scroll Fill Effect for Advanced Heading widget issue fixed
* Multiple issues fixed in the body style section of the bbPress single topic widget
* Author hover color issue fixed in the bbPress single topic widget
* Fixed title design issue in Give Login widget
* Icon display and border type issue fixed in timeline widget
* Resolved deprecation error in PHP 8.4
* Overlay color issue fixed in post gallery widget
* Tabs Widget Hash Location Issue Fixed ( Thanks to Chrystine Loriaux )
* Icon & tab alignment added in tabs widget
* Showed filter bar by taxonomy and fixed filtering issues in post gallery and post list widget
* Bottom cutting issue fixed in the Tile Scroll extension ( Thanks to Yael )
* Nav items alignment responsive issue fixed in scroll navigation widget
* Google Docs viewer for google sheets issue fixed in Document Viewer widget

= 8.4.4 [10th September 2025] =

= Added =

* Time feature added in events calendar grid widget
* Checkbox type input support added in Webhook Form widget

= 8.4.3 [9th September 2025] =

= Added =

* Viewer Type added in Document Viewer widget
* Favicon issue fixed in Backdrop Filter extension ( Thanks to Kent )
* Admin dashboard widget search issue fixed

= Fixed =

* Timeline widget vertical line not stopping at the last item for odd number of items issue fixed ( Thanks to Stefan )
* JS API data condition fixed in Open Street Map widget
* Schema issue fixed in ACF Accordion widget
* On small screens, all animation words appear in the heading issue fixed ( Thanks to Gabriel Sirbu )
* jQuery migration warning fixed ( Thanks to BackuPs )
* RTL issue fixed in Slinky Vertical Menu widget ( Thanks to Guy Ackerman )

= Updated =

* DCI Notice removed for security reasons

= 8.4.2 [28th August 2025] =

= Added =

* Liquid Glass Effects added to the Backdrop Filter extension
* Swiper carousel widgets item gap responsive feature added

= Fixed =

* Hash URL issue fixed in Wrapper Link extension ( Thanks to Jason )
* Schema issue fixed in ACF Accordion widget
* Deprication error fixed
* Swiper carousel widgets item gap ( 0 Value ) not working issue fixed

= Updated =

* Regular notices are skipped for White Label users

= 8.4.1 [21st August 2025] =

= Updated =

* Admin API Notice system updated 

= 8.4.0 [20th August 2025] =

= Added =

* Text Gradient Background extension added
* Dynamic content ACF elements added
* Link to Wrapper Item option added in product grid widget
* Title text stroke option added in circle info widget
* Copy Button style controls added in source code widget
* Custom Content feature added in the news ticker widget
* Button a & button b padding added in dual button widget

= Fixed =

* Title link "javascript:void(0)" issue fixed in circle info widget
* Sub Heading icon not showing issue fixed in advanced heading widget
* Admin API Notice loading issue fixed 

= Updated =

* License error handling updated
* Admin API notice updated
* Logo carousel navigation offset issue fixed
* News ticker except spacing issue fixed
* Sticky on Scroll Up issue fixed in Section Sticky extension ( Thanks to Dave Eddy )

= 8.3.1 [6th August 2025] =

= Added =

* Shape divider shapes visible compatibility added

= Fixed =

* Security issue fixed in Open Street Map and Advanced GMap widget ( Thanks to zer0gh0st )
* License activation issue fixed ( Benoit HAYS )

= Updated =

* Error handling improved on license page

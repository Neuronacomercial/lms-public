<div id="modulards" class="<?php echo \Modular\ConnectorDependencies\e($theme); ?> <?php echo \Modular\ConnectorDependencies\e($isConnected ? 'ds-connected' : ''); ?>">
    <div class="ds-header">
        <?php if($isWhiteLabelActive): ?>
            <h1 class="ds-title"><?php echo \Modular\ConnectorDependencies\e($title); ?></h1>
        <?php else: ?>
            <div class="ds-logo">
    ...
    <div class="ds-content <?php echo \Modular\ConnectorDependencies\e($isWhiteLabelActive || $isConnected ? 'ds-content-sm' : ''); ?>">
        <?php if(!$isWhiteLabelActive): ?>
            <div class="ds-tabs">
                <a href="?page=modular-connector" class="ds-tab <?php echo \Modular\ConnectorDependencies\e(!isset($_GET['tab']) ? 'ds-tab-active' : ''); ?>"><?php echo \Modular\ConnectorDependencies\e(esc_html__('Connection Manager', 'modular')); ?></a>
                <a href="?page=modular-connector&tab=logs" class="ds-tab <?php echo \Modular\ConnectorDependencies\e(isset($_GET['tab']) && $_GET['tab'] === 'logs' ? 'ds-tab-active' : ''); ?>"><?php echo \Modular\ConnectorDependencies\e(esc_html__('Logs', 'modular')); ?></a>
            </div>
        <?php endif; ?>
        <div class="ds-box <?php echo \Modular\ConnectorDependencies\e($isWhiteLabelActive ? 'ds-box-white' : ''); ?>">
            <div class="ds-left <?php echo \Modular\ConnectorDependencies\e($isWhiteLabelActive || $isConnected ? 'ds-left-flat' : ''); ?>">
                <?php echo $__env->make('parts.form', \Modular\ConnectorDependencies\Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

                <?php if($isConnected): ?>
                    <?php echo $__env->make('parts.connection_info', ['class' => 'ds-connection-list-flat'], \Modular\ConnectorDependencies\Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </div>

            <?php if(!$isWhiteLabelActive && !$isConnected): ?>
...
<?php /**PATH /home/academia.neuronacomercial.com/academia.neuronacomercial.com.ar/wp-content/plugins/modular-connector/src/resources/views/settings/layout.blade.php ENDPATH**/ ?>